...
public final class GlobalOpenTelemetrySdk {
    ...
    static OtelSdkConfiguration currentSdkConfiguration =
            new OtelSdkConfiguration(Collections.emptyMap(), Collections.emptyMap());

    static {
        openTelemetry = ReconfigurableOpenTelemetry.get();
        otelLogger = openTelemetry
                .getLogsBridge()
                .loggerBuilder(ExtendedJenkinsAttributes.INSTRUMENTATION_NAME)
                .build();
    }
    ...
    public static synchronized void configure(
        ...
        OtelSdkConfiguration newOtelSdkConfiguration =
                new OtelSdkConfiguration(configurationProperties, resourceAttributes);
        ...
        ConfigProperties configProperties = DefaultConfigProperties.create(configurationProperties, ComponentLoader.forClassLoader(DefaultConfigProperties.class.getClassLoader()));
        ...
        resourceAttributes.entrySet().stream()
                .filter(Predicate.not(entry ->
                        Objects.equals(ServiceIncubatingAttributes.SERVICE_INSTANCE_ID.getKey(), entry.getKey())))
    ...
    static class OtelSdkConfiguration {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(configurationProperties, that.configurationProperties)
